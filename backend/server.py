            ...
            while self.is_running and self.active_websocket:
                ...
                state = {
                    ...
                    "metrics": {
                        ...
                        "moneySupply": econ_metrics.get("money_supply", 0.0) / 1000000.0,
                        "moneyDrift": econ_metrics.get("money_drift", 0.0),
                        "governmentNetInjection": econ_metrics.get("government_net_injection", 0.0),
