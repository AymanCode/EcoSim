...
- **Persisted run artifacts** with prompt context, policy choices, accepted changes, rejected changes, final metrics, and firm-level financials for post-run analysis.
